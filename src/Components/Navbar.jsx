    ...
    <>
      ...
      <li>
        <NavLink
          className={({ isActive }) =>
            isActive
              ? "bg-transparent text-blue-50 lg:text-[#4A5568] font-semibold underline focus:bg-transparent"
              : "text-blue-50 hover:text-[#4A5568] hover:underline focus:text-[#4A5568]"
          }
          to="/addBook"
        >
      ...
      <li>
        <NavLink
          ...
          to="/borrowedBooks"
        >
          <button className="btn bg-[#eaf4ff] text[#001735]">Book A Table</button>
        </NavLink>
      </li>
    ...
    <>
      <div className="navbar py-0 w-11/12 mx-auto relative ">
        ...
        <div className="flex-none hidden lg:flex">
          <ul className="menu menu-horizontal items-center px-1 space-x-4 font-heebo">{links}</ul>
        </div>
